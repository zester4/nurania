...
const SettingsView: React.FC = () => {
  ...
  useEffect(() => {
    // If permission is denied at any point, we must disable notifications in settings.
  ...
  const handleToggle = () => {
    if (!settings.notificationsEnabled) { // Trying to enable
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <option value="adhan" disabled>Adhan (coming soon)</option>
            </select>
          </div>
